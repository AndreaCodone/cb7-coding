...
export const createLogInModal = () => {
  ...
  const closeLogInBtnEl = cE("button");
  ...
  closeLogInBtnEl.className = "loginModal__closeBtn";
  closeLogInBtnEl.textContent = "X";

  usernameInputEl.addEventListener("click", () => {
    rootEl.append(createLogInModal(userEl, rootEl));
  });
